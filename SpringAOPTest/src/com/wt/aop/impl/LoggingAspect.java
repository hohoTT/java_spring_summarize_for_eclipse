 ...
 * 
 * 3. 基于注解的方式来使用 AOP
 * 3.1 在配置文件中配置自动扫描的包: <context:component-scan base-package="com.wt.spring.aop"></context:component-scan>
 ...
 * 5.3.1 前置通知: @Before("execution(public int com.wt.spring.aop.ArithmeticCalculator.*(int, int))")
